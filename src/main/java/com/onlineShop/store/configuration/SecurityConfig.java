...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        .failureUrl("http://variety.in.net/login")
        .userInfoEndpoint()
  ...
  public CorsConfigurationSource corsConfigurationSource() {
	    ...
	    configuration.setAllowedOrigins(Arrays.asList("http://variety.in.net:8081","http://85.217.171.56:8081")); 
      ...
      return new WebMvcConfigurer() {
          ...
          public void addCorsMappings(CorsRegistry registry) {
              registry.addMapping("/**")
                  ...
                  .allowedHeaders("*")
                  .allowedOrigins("http://variety.in.net:8081","http://85.217.171.56:8081")
